...
import { ScrollState, TRACK_CLICK_BEHAVIOR } from "../../Interfaces";
import PropTypes from 'prop-types';
import Emittr from "../../libs/Emittr";
export declare type ScrollbarContextValue = {
    parentScrollbar: ScrollbarComponent | null;
};
export declare const ScrollbarContext: React.Context<ScrollbarContextValue>;
export declare class ScrollbarComponent extends React.Component<ScrollbarProps, ScrollbarState> {
